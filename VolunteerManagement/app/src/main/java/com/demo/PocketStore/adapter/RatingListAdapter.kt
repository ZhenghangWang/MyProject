...
class RatingListAdapter(private val list: List<RatingData>, private val mContext: Context) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.tv_email!!.text = meal.organisation_id.toString() + ""
        holder.tv_volid!!.text = meal.volunteer_id.toString() + ""
        holder.tv_eventid!!.text = meal.rating.toString() + ""
        holder.tv_status!!.text = meal.review + ""
        return convertView!!
    }
