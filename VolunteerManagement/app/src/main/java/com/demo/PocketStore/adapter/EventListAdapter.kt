...
class EventListAdapter(private val list: List<EventData>?, private val mContext: Context?) :
    BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            ...
            holder.iv_status = convertView.findViewById<View>(R.id.iv_status) as ImageView
            ...
            holder.item_tv_date = convertView.findViewById<View>(R.id.item_tv_date) as TextView
            holder.item_tv_org_id = convertView.findViewById<View>(R.id.item_tv_org_id) as TextView
            holder.item_tv_status = convertView.findViewById<View>(R.id.item_tv_status) as TextView
            holder.item_tv_durr = convertView.findViewById<View>(R.id.item_tv_durr) as TextView
            holder.item_tv_loc = convertView.findViewById<View>(R.id.item_tv_loc) as TextView
            holder.item_tv_skills = convertView.findViewById<View>(R.id.item_tv_skills) as TextView
        ...
        if (meal.current_application < meal.max_application) {
            ...
            holder.iv_status!!.background = mContext!!.resources.getDrawable(R.drawable.full)
        }
        return convertView!!
    }
    ...
    internal inner class ViewHolder {
        ...
        var item_tv_org_id: TextView? = null
        var item_tv_status: TextView? = null
        var item_tv_durr: TextView? = null
        var item_tv_loc: TextView? = null
        var item_tv_skills: TextView? = null
